...
exports.TextInput.prototype = {
    ...
    _attachEvents: function() {
        ...
        // Firefox and IE at the moment.
        } else {
            textField.addEventListener( 'input', function(evt) {
	            // Avoid using this event for pasted content, as it will probably split across line breaks,
	            // This is done by counting the length of the text inserted, taking into consideration the "z" hack.
	            // Don't worry about IME as it will trigger a paste event as well.
