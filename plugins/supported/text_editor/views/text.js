...
util.mixin(exports.TextView.prototype, {
    ...
    keyDown: function(evt) {
        ...
        if ( !evt.charCode || !evt._charCode ) {    // hack for Fx
    ...
    mouseDown: function(evt) {
        ...
        var point = this.computeWithClippingFrame(evt.layerX || evt.offsetX, evt.layerY || evt.offsetY);
        util.mixin(point, { layerX: evt.layerX || evt.offsetX, layerY: evt.layerY || evt.offsetY});
    ...
    mouseMove: function(evt) {
        if (this._mouseIsDown) {
            this._dragPoint = this.computeWithClippingFrame(evt.layerX || evt.offsetX, evt.layerY || evt.offsetY);
            util.mixin(this._dragPoint, { layerX: evt.layerX || evt.offsetX, layerY: evt.layerY || evt.offsetY});
            this._drag();
        }
    },
