...
/** Is the user using a browser that identifies itself as Internet Explorer */
exports.isIE = ua.indexOf("MSIE") >= 0;
...
/** Is the user using a browser that identifies itself as Opera */
exports.isOpera = ua.indexOf("Opera") >= 0;
